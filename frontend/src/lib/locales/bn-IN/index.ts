...
export const bnIN = {
  ...
  backgroundJobs: {
    chipLabel: "{{count}} ব্যাকগ্রাউন্ড",
    chipAria: "{{count}} টি ব্যাকগ্রাউন্ড জব চলছে",
    panelTitle: "ব্যাকগ্রাউন্ড জব",
    panelDesc: "সার্ভারে কিউ করা কাজ (পডকাস্ট, সোর্স, এম্বেডিং)।",
    empty: "কোনো সক্রিয় ব্যাকগ্রাউন্ড জব নেই।",
    jobPodcast: "পডকাস্ট তৈরি",
    jobSource: "সোর্স প্রসেসিং",
    jobEmbed: "এম্বেডিং",
    jobGeneric: "ব্যাকগ্রাউন্ড জব",
  },
  chat: {
    sessions: "সেশনগুলি",
    ...
    contextStillLoading: "নোটবুক সোর্স এখনও লোড হচ্ছে — একটু পরে আবার চেষ্টা করুন।",
  ...
  podcasts: {
    ...
    noEpisodesForNotebook: "এই নোটবুকের জন্য এখনও কোনো পডকাস্ট এপিসোড নেই। শুরু করতে একটি তৈরি করুন।",
    filterByNotebook: "নোটবুক দিয়ে ফিল্টার",
    allNotebooks: "সব নোটবুক",
    notebookEpisodesTitle: "পডকাস্ট এপিসোড",
    notebookEpisodesDesc: "এই নোটবুক থেকে তৈরি এপিসোড।",
    viewAllEpisodes: "সব দেখুন",
    ...
    generationQueuedWorkerDown: "সারিতে — ওয়ার্কার অফলাইন হতে পারে",
    generationQueuedWorkerDownDesc: "জব গ্রহণ করা হয়েছে, কিন্তু ব্যাকগ্রাউন্ড ওয়ার্কার চলছে বলে মনে হচ্ছে না। চালু করুন (make worker-start), নাহলে এপিসোড অপেক্ষমাণ থাকবে।",
    stageQueued: "সারিতে",
    stageOutline: "রূপরেখা",
    stageTranscript: "ট্রান্সক্রিপ্ট",
    stageTts: "বক্তৃতা",
    stageCombine: "একত্রীকরণ",
    stageCompleted: "সম্পন্ন",
    stageFailed: "ব্যর্থ",
    workerOfflineBannerTitle: "ব্যাকগ্রাউন্ড ওয়ার্কার অফলাইন বলে মনে হচ্ছে",
    workerOfflineBannerDesc: "ওয়ার্কার চালু না হওয়া পর্যন্ত পডকাস্ট, এমবেডিং ও সোর্স জব অপেক্ষমাণ থাকবে।",
