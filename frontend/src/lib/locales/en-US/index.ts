export const enUS = {
  ...
  backgroundJobs: {
    chipLabel: "{{count}} background",
    chipAria: "{{count}} background jobs running",
    panelTitle: "Background jobs",
    panelDesc: "Work queued on the server (podcasts, sources, embeddings).",
    empty: "No active background jobs.",
    jobPodcast: "Podcast generation",
    jobSource: "Source processing",
    jobEmbed: "Embeddings",
    jobGeneric: "Background job",
  },
  chat: {
    sessions: "Sessions",
    ...
    contextStillLoading: "Still loading notebook sources — try again in a moment.",
  ...
  podcasts: {
    ...
    noEpisodesForNotebook: "No podcast episodes for this notebook yet. Generate one to get started.",
    filterByNotebook: "Filter by notebook",
    allNotebooks: "All notebooks",
    notebookEpisodesTitle: "Podcast episodes",
    notebookEpisodesDesc: "Episodes generated from this notebook.",
    viewAllEpisodes: "View all",
    ...
    generationQueuedWorkerDown: "Queued — worker may be offline",
    generationQueuedWorkerDownDesc: "The job was accepted, but the background worker does not appear to be running. Start it (make worker-start) or the episode will stay pending.",
    stageQueued: "Queued",
    stageOutline: "Outline",
    stageTranscript: "Transcript",
    stageTts: "Speech",
    stageCombine: "Combining",
    stageCompleted: "Done",
    stageFailed: "Failed",
    workerOfflineBannerTitle: "Background worker looks offline",
    workerOfflineBannerDesc: "Podcast, embedding, and source jobs will sit pending until the worker is started.",
