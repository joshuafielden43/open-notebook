...
export const esES = {
  ...
  backgroundJobs: {
    chipLabel: "{{count}} en segundo plano",
    chipAria: "{{count}} trabajos en segundo plano",
    panelTitle: "Trabajos en segundo plano",
    panelDesc: "Trabajo en cola en el servidor (podcasts, fuentes, embeddings).",
    empty: "No hay trabajos activos en segundo plano.",
    jobPodcast: "Generación de podcast",
    jobSource: "Procesamiento de fuentes",
    jobEmbed: "Embeddings",
    jobGeneric: "Trabajo en segundo plano",
  },
  chat: {
    sessions: "Sesiones",
    ...
    contextStillLoading: "Aún se están cargando las fuentes del cuaderno — inténtalo de nuevo en un momento.",
  ...
  podcasts: {
    ...
    noEpisodesForNotebook: "Aún no hay episodios de podcast para este cuaderno. Genera uno para empezar.",
    filterByNotebook: "Filtrar por cuaderno",
    allNotebooks: "Todos los cuadernos",
    notebookEpisodesTitle: "Episodios de podcast",
    notebookEpisodesDesc: "Episodios generados desde este cuaderno.",
    viewAllEpisodes: "Ver todos",
    ...
    generationQueuedWorkerDown: "En cola — el worker puede estar offline",
    generationQueuedWorkerDownDesc: "El trabajo se aceptó, pero el worker en segundo plano no parece estar en ejecución. Inícialo (make worker-start) o el episodio seguirá pendiente.",
    stageQueued: "En cola",
    stageOutline: "Guion",
    stageTranscript: "Transcripción",
    stageTts: "Voz",
    stageCombine: "Combinando",
    stageCompleted: "Listo",
    stageFailed: "Fallido",
    workerOfflineBannerTitle: "El worker en segundo plano parece offline",
    workerOfflineBannerDesc: "Los trabajos de podcast, embedding y fuentes permanecerán pendientes hasta que se inicie el worker.",
