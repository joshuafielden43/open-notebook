...
export const frFR = {
  ...
  backgroundJobs: {
    chipLabel: "{{count}} en arrière-plan",
    chipAria: "{{count}} tâches en arrière-plan",
    panelTitle: "Tâches en arrière-plan",
    panelDesc: "Travail en file sur le serveur (podcasts, sources, embeddings).",
    empty: "Aucune tâche active en arrière-plan.",
    jobPodcast: "Génération de podcast",
    jobSource: "Traitement des sources",
    jobEmbed: "Embeddings",
    jobGeneric: "Tâche en arrière-plan",
  },
  chat: {
    sessions: "Sessions",
    ...
    contextStillLoading: "Chargement des sources du carnet en cours — réessayez dans un instant.",
  ...
  podcasts: {
    ...
    noEpisodesForNotebook: "Aucun épisode de podcast pour ce carnet. Générez-en un pour commencer.",
    filterByNotebook: "Filtrer par carnet",
    allNotebooks: "Tous les carnets",
    notebookEpisodesTitle: "Épisodes de podcast",
    notebookEpisodesDesc: "Épisodes générés à partir de ce carnet.",
    viewAllEpisodes: "Tout voir",
    ...
    generationQueuedWorkerDown: "En file — le worker peut être hors ligne",
    generationQueuedWorkerDownDesc: "Le job a été accepté, mais le worker d'arrière-plan ne semble pas tourner. Démarrez-le (make worker-start) ou l'épisode restera en attente.",
    stageQueued: "En file",
    stageOutline: "Plan",
    stageTranscript: "Transcription",
    stageTts: "Voix",
    stageCombine: "Assemblage",
    stageCompleted: "Terminé",
    stageFailed: "Échoué",
    workerOfflineBannerTitle: "Le worker d'arrière-plan semble hors ligne",
    workerOfflineBannerDesc: "Les jobs de podcast, d'embedding et de sources resteront en attente tant que le worker n'est pas démarré.",
