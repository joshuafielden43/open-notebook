...
export const itIT = {
  ...
  backgroundJobs: {
    chipLabel: "{{count}} in background",
    chipAria: "{{count}} processi in background",
    panelTitle: "Processi in background",
    panelDesc: "Lavoro in coda sul server (podcast, fonti, embedding).",
    empty: "Nessun processo attivo in background.",
    jobPodcast: "Generazione podcast",
    jobSource: "Elaborazione fonti",
    jobEmbed: "Embedding",
    jobGeneric: "Processo in background",
  },
  chat: {
    sessions: "Sessioni",
    ...
    contextStillLoading: "Caricamento delle fonti del taccuino ancora in corso — riprova tra un momento.",
  ...
  podcasts: {
    ...
    noEpisodesForNotebook: "Ancora nessun episodio podcast per questo quaderno. Generane uno per iniziare.",
    filterByNotebook: "Filtra per quaderno",
    allNotebooks: "Tutti i quaderni",
    notebookEpisodesTitle: "Episodi podcast",
    notebookEpisodesDesc: "Episodi generati da questo quaderno.",
    viewAllEpisodes: "Vedi tutti",
    ...
    generationQueuedWorkerDown: "In coda — il worker potrebbe essere offline",
    generationQueuedWorkerDownDesc: "Il job è stato accettato, ma il worker in background non sembra in esecuzione. Avvialo (make worker-start) o l'episodio resterà in sospeso.",
    stageQueued: "In coda",
    stageOutline: "Scaletta",
    stageTranscript: "Trascrizione",
    stageTts: "Voce",
    stageCombine: "Combinazione",
    stageCompleted: "Fatto",
    stageFailed: "Non riuscito",
    workerOfflineBannerTitle: "Il worker in background sembra offline",
    workerOfflineBannerDesc: "I job di podcast, embedding e fonti resteranno in sospeso finché il worker non viene avviato.",
