...
export const jaJP = {
  ...
  backgroundJobs: {
    chipLabel: "バックグラウンド {{count}}",
    chipAria: "バックグラウンドジョブ {{count}} 件",
    panelTitle: "バックグラウンドジョブ",
    panelDesc: "サーバーでキューされている作業（ポッドキャスト、ソース、埋め込み）。",
    empty: "実行中のバックグラウンドジョブはありません。",
    jobPodcast: "ポッドキャスト生成",
    jobSource: "ソース処理",
    jobEmbed: "埋め込み",
    jobGeneric: "バックグラウンドジョブ",
  },
  chat: {
    sessions: "セッション",
    ...
    contextStillLoading: "ノートブックのソースを読み込み中です。しばらくしてから再試行してください。",
  ...
  podcasts: {
    ...
    noEpisodesForNotebook: "このノートブックのポッドキャストエピソードはまだありません。生成して始めましょう。",
    filterByNotebook: "ノートブックで絞り込み",
    allNotebooks: "すべてのノートブック",
    notebookEpisodesTitle: "ポッドキャストエピソード",
    notebookEpisodesDesc: "このノートブックから生成されたエピソード。",
    viewAllEpisodes: "すべて表示",
    ...
    generationQueuedWorkerDown: "キュー待ち — ワーカーがオフラインの可能性",
    generationQueuedWorkerDownDesc: "ジョブは受け付けられましたが、バックグラウンドワーカーが動いていないようです。起動する（make worker-start）か、エピソードは保留のままになります。",
    stageQueued: "キュー",
    stageOutline: "アウトライン",
    stageTranscript: "台本",
    stageTts: "音声",
    ...
    stageCompleted: "完了",
    stageFailed: "失敗",
    workerOfflineBannerTitle: "バックグラウンドワーカーがオフラインのようです",
    workerOfflineBannerDesc: "ワーカーを起動するまで、ポッドキャスト・埋め込み・ソースのジョブは保留のままです。",
