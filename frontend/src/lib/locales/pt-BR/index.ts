...
export const ptBR = {
  ...
  backgroundJobs: {
    chipLabel: "{{count}} em segundo plano",
    chipAria: "{{count}} tarefas em segundo plano",
    panelTitle: "Tarefas em segundo plano",
    panelDesc: "Trabalho na fila do servidor (podcasts, fontes, embeddings).",
    empty: "Nenhuma tarefa ativa em segundo plano.",
    jobPodcast: "Geração de podcast",
    jobSource: "Processamento de fontes",
    jobEmbed: "Embeddings",
    jobGeneric: "Tarefa em segundo plano",
  },
  chat: {
    sessions: "Sessões",
    ...
    contextStillLoading: "Ainda carregando as fontes do caderno — tente de novo em instantes.",
  ...
  podcasts: {
    ...
    noEpisodesForNotebook: "Nenhum episódio de podcast para este caderno ainda. Gere um para começar.",
    filterByNotebook: "Filtrar por caderno",
    allNotebooks: "Todos os cadernos",
    notebookEpisodesTitle: "Episódios de podcast",
    notebookEpisodesDesc: "Episódios gerados a partir deste caderno.",
    ...
    generationQueuedWorkerDown: "Na fila — o worker pode estar offline",
    generationQueuedWorkerDownDesc: "O job foi aceito, mas o worker em segundo plano parece não estar em execução. Inicie-o (make worker-start) ou o episódio ficará pendente.",
    stageQueued: "Na fila",
    stageOutline: "Roteiro",
    stageTranscript: "Transcrição",
    stageTts: "Fala",
    stageCombine: "Combinando",
    stageCompleted: "Concluído",
    stageFailed: "Falhou",
    workerOfflineBannerTitle: "Worker em segundo plano parece offline",
    workerOfflineBannerDesc: "Jobs de podcast, embedding e fontes ficarão pendentes até o worker ser iniciado.",
