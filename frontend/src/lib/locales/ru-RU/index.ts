...
export const ruRU = {
  ...
  backgroundJobs: {
    chipLabel: "{{count}} фоновых",
    chipAria: "{{count}} фоновых заданий",
    panelTitle: "Фоновые задания",
    panelDesc: "Очередь на сервере (подкасты, источники, эмбеддинги).",
    empty: "Нет активных фоновых заданий.",
    jobPodcast: "Генерация подкаста",
    jobSource: "Обработка источников",
    jobEmbed: "Эмбеддинги",
    jobGeneric: "Фоновое задание",
  },
  chat: {
    sessions: "Сессии",
    ...
    contextStillLoading: "Источники блокнота ещё загружаются — попробуйте через мгновение.",
  ...
  podcasts: {
    ...
    noEpisodesForNotebook: "Для этого блокнота пока нет эпизодов подкаста. Создайте первый.",
    filterByNotebook: "Фильтр по блокноту",
    allNotebooks: "Все блокноты",
    notebookEpisodesTitle: "Эпизоды подкаста",
    notebookEpisodesDesc: "Эпизоды, созданные из этого блокнота.",
    viewAllEpisodes: "Показать все",
    ...
    generationQueuedWorkerDown: "В очереди — worker может быть офлайн",
    generationQueuedWorkerDownDesc: "Задача принята, но фоновый worker, похоже, не запущен. Запустите его (make worker-start), иначе эпизод останется в ожидании.",
    stageQueued: "В очереди",
    stageOutline: "План",
    stageTranscript: "Стенограмма",
    stageTts: "Речь",
    stageCombine: "Сборка",
    stageCompleted: "Готово",
    stageFailed: "Ошибка",
    workerOfflineBannerTitle: "Фоновый worker, похоже, офлайн",
    workerOfflineBannerDesc: "Задачи подкастов, эмбеддингов и источников будут ждать, пока worker не будет запущен.",
