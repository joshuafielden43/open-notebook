...
export const zhCN = {
  ...
  backgroundJobs: {
    chipLabel: "{{count}} 后台任务",
    chipAria: "{{count}} 个后台任务正在运行",
    panelTitle: "后台任务",
    panelDesc: "服务器队列中的工作（播客、来源、嵌入）。",
    empty: "没有进行中的后台任务。",
    jobPodcast: "播客生成",
    jobSource: "来源处理",
    jobEmbed: "嵌入",
  ...
  chat: {
    ...
    contextStillLoading: "仍在加载笔记本来源 — 请稍后再试。",
  ...
  podcasts: {
    ...
    noEpisodesForNotebook: "此笔记本尚无播客单集。生成一个即可开始。",
    filterByNotebook: "按笔记本筛选",
    allNotebooks: "全部笔记本",
    notebookEpisodesTitle: "播客单集",
    notebookEpisodesDesc: "从此笔记本生成的单集。",
    ...
    generationQueuedWorkerDown: "已排队 — 工作进程可能离线",
    generationQueuedWorkerDownDesc: "任务已接受，但后台工作进程似乎未运行。请启动它（make worker-start），否则剧集将一直处于等待状态。",
    stageQueued: "排队中",
    stageOutline: "大纲",
    stageTranscript: "文稿",
    stageTts: "语音",
    ...
    stageCompleted: "完成",
    stageFailed: "失败",
    workerOfflineBannerTitle: "后台工作进程似乎离线",
    workerOfflineBannerDesc: "在启动工作进程之前，播客、嵌入和来源任务将一直处于等待状态。",
