...
export const zhTW = {
  ...
  backgroundJobs: {
    chipLabel: "{{count}} 背景工作",
    chipAria: "{{count}} 個背景工作執行中",
    panelTitle: "背景工作",
    panelDesc: "伺服器佇列中的工作（播客、來源、嵌入）。",
    empty: "沒有進行中的背景工作。",
    jobPodcast: "播客產生",
    jobSource: "來源處理",
    jobEmbed: "嵌入",
  ...
  chat: {
    ...
    contextStillLoading: "仍在載入筆記本來源 — 請稍後再試。",
  ...
  podcasts: {
    ...
    noEpisodesForNotebook: "此筆記本尚無播客單集。產生一個即可開始。",
    filterByNotebook: "依筆記本篩選",
    allNotebooks: "全部筆記本",
    notebookEpisodesTitle: "播客單集",
    notebookEpisodesDesc: "從此筆記本產生的單集。",
    viewAllEpisodes: "查看全部",
    ...
    generationQueuedWorkerDown: "已排隊 — 工作進程可能離線",
    generationQueuedWorkerDownDesc: "工作已接受，但背景工作進程似乎未執行。請啟動它（make worker-start），否則劇集將一直處於等待狀態。",
    stageQueued: "排隊中",
    stageOutline: "大綱",
    stageTranscript: "文稿",
    stageTts: "語音",
    ...
    stageCompleted: "完成",
    stageFailed: "失敗",
    workerOfflineBannerTitle: "背景工作進程似乎離線",
    workerOfflineBannerDesc: "在啟動工作進程之前，Podcast、嵌入與來源任務將一直處於等待狀態。",
